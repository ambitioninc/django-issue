# -*- coding: utf-8 -*-
#
# django-issue documentation build configuration file
import inspect
import os
import re
...
htmlhelp_basename = 'django-issuedoc'
...
latex_documents = [
  ('index', 'django-issue.tex', u'django-issue Documentation',
...
man_pages = [
    ('index', 'django-issue', u'django-issue Documentation',
     [u'Josh Marlow'], 1)
]
...
texinfo_documents = [
  ('index', 'django-issue', u'django-issue Documentation',
   u'Josh Marlow', 'django-issue', 'A short description',
   'Miscellaneous'),
]
