...
class CheckAssertionsTests(TestCase):
    @patch.object(ModelAssertion, 'check_assertions', spec_set=True, return_value=False)
    @patch.object(Assertion, 'check_assertions', spec_set=True, return_value=False)
    ...
    @patch.object(Assertion, 'check_assertions', spec_set=True, side_effect=[True, False])
